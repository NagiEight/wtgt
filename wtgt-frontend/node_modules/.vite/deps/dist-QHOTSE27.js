...
import {
  Hls,
  MediaTracksMixin
} from "./chunk-5RCLSGO4.js";
import {
  CustomVideoElement
} from "./chunk-AG7TGYOM.js";
import {
  require_react
...
onCastApiAvailable(() => {
  ...
  if (!cf) {
    ...
    castContext().addEventListener(cf.CastContextEventType.CAST_STATE_CHANGED, (e2) => {
      remoteInstances.forEach((r12) => privateProps.get(r12).onCastStateChanged?.(e2));
    });
    castContext().addEventListener(cf.CastContextEventType.SESSION_STATE_CHANGED, (e2) => {
      remoteInstances.forEach((r12) => privateProps.get(r12).onSessionStateChanged?.(e2));
    });
    remoteInstances.forEach((r12) => privateProps.get(r12).init?.());
  }
});
...
var MediaTimeRange = class extends MediaChromeRange {
  ...
  set mediaChaptersCues(value) {
    ...
    this.updateSegments(
      (_a4 = __privateGet19(this, _mediaChaptersCues)) == null ? void 0 : _a4.map((c4) => ({
...
mux-embed/dist/mux.mjs:
  ...
  *)
*/
//# sourceMappingURL=dist-QHOTSE27.js.map
