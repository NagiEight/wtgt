...
const Connect = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-16 text-center text-(--color-text) bg-(--color-bg)">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
                <button
                    ...
                    className="px-6 py-3 rounded-md font-semibold text-(--color-text) transition-all duration-200 ease-out shadow hover:shadow-lg hover:scale-105"
